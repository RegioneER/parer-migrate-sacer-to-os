...
package it.eng.parer.migrate.sacer.os.beans.sipaggmetadati.job;
...
import it.eng.parer.migrate.sacer.os.beans.sipaggmetadati.job.predicate.MigrateOsSipAggMetadatiRequestPredicate;
...
@ApplicationScoped
public class MigrateOsSipAggMetadatiJob {
    private static final Logger log = LoggerFactory.getLogger(MigrateOsSipAggMetadatiJob.class);
