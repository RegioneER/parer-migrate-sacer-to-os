...
package it.eng.parer.migrate.sacer.os.beans.upddatispec.job;
...
import it.eng.parer.migrate.sacer.os.beans.upddatispec.job.predicate.MigrateOsUpdDatiSpecAggMdRequestPredicate;
...
@ApplicationScoped
public class MigrateOsUpdDatiSpecAggMdJob {
    private static final Logger log = LoggerFactory.getLogger(MigrateOsUpdDatiSpecAggMdJob.class);
	...
	Requests osSipRequest = osBaseService
		.findAndLockOsRequestBeforeStart(RequestCnts.Type.UPD_DATI_SPEC_INI);
	// 1.1. init MDC
